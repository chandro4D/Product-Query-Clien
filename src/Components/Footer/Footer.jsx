...
const Footer = () => {
    return (
        <footer className="footer footer-center p-10 bg-primary text-primary-content  h-[400px] " style={{ backgroundImage: 'url(https://i.ibb.co/f4L9JcS/pexels-asad-photo-maldives-1450340.jpg)' }}>
            <aside>
                ...
                AlterNative Limited <br />Providing many  facilities since 2000
                </p>
                <p>Copyright © 2024 - All right reserved</p>
                <img className="w-[90px] h-[90px] bg-slate-300 rounded-full" src="https://i.ibb.co/M179kmX/Pngtree-creative-s-logo-4259366.png" alt="" />
